                ...
                <div class="menu-bar flex">
                    <div class="menu-links">
                        <ul>
                            ...
                            <li class="nav-links flex">
                                <a href="affiche_parcelle.php">
                                    <i class="bx bx-cart"></i>
                                    <span class=" text hidden-text menu">Nos parcelles</span>
                               </a> 
                            </li>
                            <li class="nav-links flex">
                                <a href="affiche_appart.php">
                                    <i class="bx bx-store-alt"></i>
                                    <span class=" text hidden-text menu">Nos appartements</span>
                               </a> 
                            </li>
                            <li class="nav-links flex">
                                <a href="save_parcelle.php">
                                    <i class="bx bx-user"></i>
                                    <span class=" text hidden-text menu">Enregistrez votre parcelle</span>
                               </a> 
                            </li>
                            <li class="nav-links flex">
                                <a href="save_appartement.php">
                                    <i class="bx bx-user"></i>
                                    <span class=" text hidden-text menu">Enregistrez votre appartement</span>
                               </a> 
                            </li>
                            ...
                            <li class="nav-links flex">
                                <a href="administration.php">
                                    ...
                                    <span class=" text hidden-text menu">Administration</span>
                               </a> 
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="name-role-notifications flex">
                        ...
                        <div class="name-role-picture flex">
                            ...
                            <div class="name-role flex">
                                ...
                                <div class="role-description flex"><span class="role"><a href="acount.php">Mon compte </a><i class="fa fas fa-angle-down discription"></i></span></div>
                            </div>
                        </div>
                    </div>
                </div>
